...
%
% Adapted for Somatomapping data
%
%
%
%
...
function [mu, Sigma, ppi]=FUNC_run_GaussianMM(InitParams,Spikes)
%
...
P = waitbar(1/100,'Iteration 1/100');
set(P, 'Position', [1552 194 270 56]);
...
for i = 1:100
    ...
    waitbar(i/100,P,['Iteration ',num2str(i),'/100']);
